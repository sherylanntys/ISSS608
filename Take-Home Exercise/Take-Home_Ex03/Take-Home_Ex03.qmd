...
-   **Station Selection**: Users should be able to select which weather station's data they want to view.

-   **Year Selection**: Users should have the ability to choose the year of interest.

-   **Variable Selection**: Users should have the ability to select between different weather variables and measurement.
...
```{r}
str(climate_windspeed_interpolated)
```

## 3.2 Sunburst Diagram

```{r}
str(climate_temperature_interpolated)
```
